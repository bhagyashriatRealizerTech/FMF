 ...
 */
public class TrackFriendBackgroundAsyncTask extends AsyncTask<Void,Void,StringBuilder> {
    ...
    public TrackFriendBackgroundAsyncTask(String frndid,Context mycontext, OnTaskCompleted cb) {
    ...
    protected void onPostExecute(StringBuilder stringBuilder) {
        ...
        stringBuilder.append("@@@TrackFriendBackGround");
