 ...
 */
public class SetThreadNameAsyncTask extends AsyncTask<Void,Void,StringBuilder> {
    ...
    public SetThreadNameAsyncTask(String tid,String tname,Context mycontext, OnTaskCompleted cb) {
    ...
    protected StringBuilder doInBackground(Void... params) {
        ...
        String url= Config.URL_Chat+"setThreadName";
